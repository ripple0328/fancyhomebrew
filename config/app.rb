...
Volt.configure do |config|
  ...
  #######################################
  config.domain = 'fancyhomebrew.com'
  config.app_name = 'Fancyhomebrew'
  config.mailer.from = 'Fancyhomebrew <no-reply@fancyhomebrew.com>'
  ...
  #
  config.app_secret = 'MeJ20WcuIrqkD805fTzHDeTSl443QetYEasX3YKfzuI7G9DaoVwVJiHaQJpHRj6vLU4'
